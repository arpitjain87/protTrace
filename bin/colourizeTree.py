...
def main(nexusTreeFile, mapFile, protId, spTree, plotFigTree, speciesMaxLikFile, species_id):
	global sp_max_file, hamstrMapFile, speciesId, speciesTree, decayRate, decayPop, traceResults
