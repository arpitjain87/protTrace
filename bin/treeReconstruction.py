...
def main(Raxml, Linsi, Clustalw, Degap, Orthologs, AaMatrix, Protein_id, Puzzle, Params_puzzle, Map_file, Species_maxLikMatrix, Scale_file, Tree_file, delTemp, defScale, cache_dir):
	...
	global raxml, linsi, clustalw, degap, orth_file, aaMatrix, protein_id, puzzle, params_puzzle, map_file, species_maxLikMatrix, scaleFile, treeFile, phy_file, aln_file, sf, cacheDir
	cacheDir = cache_dir
	raxml = Raxml
	linsi = Linsi
	clustalw = Clustalw
